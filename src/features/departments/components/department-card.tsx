 ...
 */
export function DepartmentCard({ title }: DepartmentCardProps) {
  return (
      ...
      <div className="tw-relative tw-overflow-hidden tw-bg-white tw-rounded-xl tw-p-6 tw-shadow-lg hover:tw-shadow-xl tw-transition-all tw-duration-300 tw-border tw-border-gray-100 group-hover:tw-border-primary/30">
        ...
        <div className="tw-relative tw-flex tw-flex-col tw-h-full">
          ...
          <div className="tw-mt-auto">
            <div className="tw-inline-flex tw-items-center tw-text-primary tw-font-semibold tw-mt-4 group-hover:tw-translate-x-2 tw-transition-transform">
